...
def init(context):
    ...
    y_train = y_all[:-1]
    # 训练SVM
    context.clf = svm.SVC(C=1.0, kernel='rbf', degree=3, gamma='auto', coef0=0.0, shrinking=True,
...
def on_bar(context, bars):
    ...
    # 于星期一的09:31:00进行操作
    # 当前bar的工作日
    weekday = datetime.strftime(today, '%Y-%m-%d').isoweekday()
    # 获取模型相关的数据
    # 获取持仓
